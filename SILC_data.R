...
SILC$SZNEV_VIZSGALT <- gsub("Ë", "E", SILC$SZNEV_VIZSGALT) 
...
SILC$ANYNEV_VIZSGALT <- gsub("Ë", "E", SILC$ANYNEV_VIZSGALT) 
...
nrow(SILC %>% filter(Kategoria == 1 & Talalt == 0)) # 3722, 3181, 2472, 2329, 2140, 2098, 2071, 2055,   # 3723, 3182, 2473, 2331, 2142, 2138, 2097, 2091, 2083, 2064, 2060, 2042, 2019, 2011  
...
nrow(SILC %>% filter(Kategoria == 1 & Talalt == 1)) # 3614, 4155, 4864, 5007, 5196, 5238, 5265, 5281,     # 3613, 4154, 4863, 5005, 5194, 5198, 5239, 5245, 5253, 5272, 5276, 5294, 5317, 5325, 
...
# database[database$AAJE == "8403913621", ]
